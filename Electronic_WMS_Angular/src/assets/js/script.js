exports.CustomFunc = function () {
  ...
  document.addEventListener("DOMContentLoaded", function () {
    ...
    // feather.replace(); //icon feather -> Node: dùng trong angular phải cài thư viện
    ...
    var header = document.getElementById("sidebar-body");
    var btns = header.getElementsByClassName("check-menu-active");
